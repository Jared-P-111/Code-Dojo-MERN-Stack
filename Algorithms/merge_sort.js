...
function merge(left = [], right = []) {
  ...
  //🧈 Check to see which array at index's has the lower values. Then pushes to common array
  ...
  //🧈 Clean up if elements are left after in left array
  while (i < left.length) {
    combined.push(left[i]);
    i++;
  }

  //🧈 Clean up if elements are left in the right array
